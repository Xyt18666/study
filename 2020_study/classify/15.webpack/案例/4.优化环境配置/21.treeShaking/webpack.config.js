...
通俗意思就是 摇晃 树木， 有被使用的文件代码 视为绿色，未被使用的视为灰色，他会自动去除这些灰色的 叶子



package 中 配置  "sidEffects":false  ：所以代码都没有副作用
"sidEffects":["*.css"]    这些css文件不会在 执行 tree shaking 




前题： 必须使用es6模块 ，必须开启 production 环境
